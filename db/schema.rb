...
ActiveRecord::Schema.define(version: 20_190_907_190_713) do
  create_table 'friendly_id_slugs', id: :integer, force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8' do |t|
    ...
    t.index %w[slug sluggable_type scope], name: 'index_friendly_id_slugs_on_slug_and_sluggable_type_and_scope', unique: true, length: { slug: 20, sluggable_type: 20, scope: 20 }
    t.index %w[slug sluggable_type], name: 'index_friendly_id_slugs_on_slug_and_sluggable_type', length: { slug: 20, sluggable_type: 20 }
